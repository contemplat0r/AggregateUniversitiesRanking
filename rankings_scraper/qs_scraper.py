...
if __name__ == "__main__":
    ...
    rank_data_sources_description = list()
    ...
    #qs_url = 'http://www.topuniversities.com/university-rankings/world-university-rankings/2015#sorting=rank+region=+country=+faculty=+stars=false+search='
    qs_url = 'http://www.topuniversities.com/university-rankings/world-university-rankings/2015'

    headers = {'User-Agent' : user_agent_header}
    qs_html = get_html(qs_url, headers)
    save_html(qs_html, 'QS_by_Requests.html')
