...
rankingApp.controller('RankingTableController', function($scope, $http) {
    ...
    $scope.setPageSize = function(pageSizeId) {
        var pageSizeIndex = Number(pageSizeId)
...
rankingApp.controller('NavigationController', function($scope, $timeout, $http) {
...
$scope.langSelect = {
    ...
    $scope.retrieveBigSiteTexts = function() {
        console.log('Entry in retrieveBigSiteTexts');
        $http({
            //method : 'POST',
            method : 'GET',
            url : 'rest/texts',
            ...
            function successCallback(response) {
                console.log('retrieveBigSiteTexts, success: ' + response);
                methodologyEn = response.methodologyTextEn;
                methodologyRu = response.methodologyTextRu;
            },
            function errorrCallback(response) {
                //console.log('retrieveTableData, error: ', response);
                ;
